...
## Disclaimer:
These slides are copyrighted and
...
, it is intended for per sonal use and exam
...
## 30
AWS ser vices
•AWS / IT Beginner s welcome! (but take your time, it’s not a race)
...
About me
•I’m Stephane!
•Wor ked as in IT consultant and AWS Solutions Architect, Developer & SysOps
•Wor ked with AWS many year s: built websites, apps, streaming platfor ms
•Veteran Instructor on AWS (Certifications, CloudFormation, Lambda, EC2...)
•Yo u   c a n   f i n d   m e   o n
...
•Tw i t t e r : https://twitter.com/stephanemaarek
...
•AWS power s some of the biggest websites in the wor ld
•Amazon.com
•Netflix
...
•Use cases include
•Enterprise IT, Backup & Stor age , Big Data analytics
...
requirements:
data never leaves a region without
your explicit permission
## •
Proximity to customers:
reduced latency
## •
Available ser vices within a Region:
new services
and new features aren’t available in every Region
## •
## Pricing:
pricing varies region to region and is
...
To u r   o f   t h e  A W S   C o n s o l e
## •
AWS has Global Ser vices:
...
BobCharlesDavid
## Edward
Group: DevelopersGroup: Operations
## Group
## Audit Team
## Fred
...
## •
Yo u   w a n t   t o   p r o t e c t   y o u r   R o o t  A c c o u n t s   a n d   I A M   u s e r s
...
Provided by Gemalto (3
rd
party)
Hardware Key Fob MFA Device for
AWS GovCloud (US)
Provided by SurePassID (3
rd
party)
...
•To   a c c e s s  A W S ,  y o u   h a v e   t h r e e   o p t i o n s :
## •
...
•Yo u   c a n   d e v e l o p   s c r i p t s   t o   m a n a g e   y o u r   r e s o u r c e s
...
•To   d o   s o ,  w e   w i l l   a s s i g n
permissions
to AWS services
with
IAM Roles
...
•Yo u   c a n   u s e   t h i s   i n f o r m a t i o n   t o   r e v i s e   y o u r   p o l i c i e s .
...
•One physical user = One AWS
user
## •
Assign users to groups
and assign permissions to groups
•Create a
strong password policy
•Use and enforce the use of
Multi Factor Authentication (MFA)
•Create and use
## Roles
for giving permissions to AWS services
•Use Access Keys for Programmatic Access (CLI / SDK)
•Audit permissions of your account using IAM Credentials Repor t & IAM
## Access Advisor
## •
...
•That script is only run once at the instance first star t
...
•We’ll be launching our fir st vir tual ser ver using the AWS Console
•We’ll get a fir st high-level approach to the various parameters
•We’ll see that our web server is launched using EC2 user data
•We’ll lear n how to star t / stop / ter minate our instance .
...
m5.2xlarge
•m: instance class
•5: gener ation (AWS improves them over time)
...
•SSH is one of the most important function. It allows you to control a
remote machine, all using the command line.
•We will configure all the required par ameter s necessar y for doing SSH
...
## •
Wor ks only out-of-the-box with Amazon Linux 2
...
•Yo u   r e s e r v e   a   s p e c i f i c   i n s t a n c e   a t t r i b u t e s
...
•Yo u   c a n   b u y   a n d   s e l l   i n   t h e   R e s e r v e d   I n s t a n c e   M a r k e t p l a c e
## •
...
•Te n a n c y   ( H o s t ,  D e d i c a t e d ,  D e f a u l t )
...
distributed
workloads
•Wor kloads with a flexible star t and end time
## •
...
You can only cancel Spot Instance requests that areopen,active, ordisabled.
...
## •
lowestPrice:
from the pool with the lowest price (cost optimization, shor t workload)
## •
diversified:
...
pools with highest capacity available, then select
...
IPaddress, you can mask the failure of an instance or software
...
•A MAC address
•Yo u   c a n   c r e a t e   E N I   i n d e p e n d e n t l y   a n d   a t t a c h
...
EC2 Hibernate
•We know we can stop, ter minate instances
## •
## Stop
...
## •
## Root Volume –
must be EBS, encr ypted, not instance store, and large
•Available for
On-Demand
## ,
## Reserved
...
•To   m o v e   a   v o l u m e   a c r o s s ,  y o u   f i r s t   n e e d   t o   s n a p s h o t   i t
•Have a provisioned capacity (size in GBs, and IOPS)
•Yo u   g e t   b i l l e d   f o r   a l l   t h e   p r o v i s i o n e d   c a p a c i t y
•Yo u   c a n   i n c r e a s e   t h e   c a p a c i t y   o f   t h e   d r i v e   o v e r   t i m e
...
customization
of an EC2 instance
•Yo u   a d d   y o u r   o w n   s o f t w a r e ,  c o n f i g u r a t i o n ,  o p e r a t i n g   s y s t e m ,  m o n i t o r i n g ...
•Faster boot / configuration time because all your software is pre-packaged
•AMI are built for a
specific region
(and can be copied across regions)
...
•EBS volumes are
network drives
with good but “limited” performance
## •
...
•gp2 / gp3 (SSD): G ener al pur pose S S D volume that balances pr ice and perfor mance for
a wide variety of workloads
•io1 / io2 Block Express (SSD): H ighest-performance SSD volume for mission-critical
...
•Great for
databases workloads
(sensitive to storage perf and consistency)
•io1 (4 GiB - 16 TiB):
...
## •
## Standard
: fo r fre q ue ntly  ac c e s s e d  file s
## •
...
## •
## Archive:
rarely accessed data (few times each year), 50%
cheaper
•Implement
lifecycle policies
to move files between storage
tiers
## •
...
•To   m i g r a t e   a n   E B S   v o l u m e   a c r o s s  A Z
•Ta k e   a   s n a p s h o t
...
Ver tical Scalability
•Ver tically scalability means increasing the size
of the instance
•For example, your application runs on a
t2.micro
•Scaling that application vertically means
running it on a t2.large
•Ver tical scalability is ver y common for non
...
ver tically scale (hardware limit)
...
•AWS guarantees that it will be wor king
...
Ty p e s   o f   l o a d   b a l a n c e r   o n  AW S
•AWS has
...
•Routing based on path in URL   (example.com
## /users &
example.com/
posts
## )
...
•We can also get Por t (X-Forwarded-Por t) and proto (X-Forwarded-Proto)
## EC2
## Instance
Client IP
## 12.34.56.78
...
Network Load Balancer – Ta r g e t   G r o u p s
## •
EC2 instances
## •
IP Addresses
...
## •
## Application Load Balancer
•Health Checks support the
TCP, HTTP and HTTPS Protocols
## Target Group
(EC2 Instances)
i-1234567890abcdef0i-1234567890abcdef0
## Network
## Load Balancer
## Target Group
(IP Addresses)
...
## Gateway Load Balancer
•Deploy, scale, and manage a fleet of 3
rd
party
...
## •
Tr a n s p a r e n t   N e t w o r k   G a t e w ay
– single entry/exit
for all traffic
## •
## Load Balancer
– distributes traffic to your virtual
appliances
•Uses the
## GENEVE
protocol on port
...
Gateway Load Balancer – Ta r g e t   G r o u p s
## •
EC2 instances
## •
IP Addresses
...
•This works for
## Classic Load Balancer, Application
...
•Disabled by default
•Yo u   p a y   c h a r g e s   ( $ )   f o r   i n t e r  A Z   d a t a   i f   e n a b l e d
## •
## Classic Load Balancer
•Disabled by default
...
## •
## SSL
refers to Secure Sockets Layer, used to encrypt connections
## •
## TLS
refers to Transport Layer Security, which is a newer version
•Nowadays,
...
•Yo u   c a n   m a n a g e   c e r t i f i c a t e s   u s i n g  A C M   ( A W S   C e r t i f i c a t e   M a n a g e r )
•Yo u   c a n   c r e a t e   u p l o a d   y o u r   o w n   c e r t i f i c a t e s   a l t e r n a t i v e l y
•HTTPS listener:
•Yo u   m u s t   s p e c i f y   a   d e f a u l t   c e r t i f i c a t e
•Yo u   c a n   a d d   a n   o p t i o n a l   l i s t   o f   c e r t s   t o   s u p p o r t   m u l t i p l e   d o m a i n s
## •
Clients can use SNI (Server Name Indication) to specify the hostname they reach
•Ability to specify a security policy to suppor t older versions of SSL / TLS (legacy clients)
## EC2
## Instance
## Users
HTTPS (encrypted)
...
•SNI solves the problem of loading
multiple SSL
cer tificates onto one web server
(to serve
multiple websites)
...
cer tificate, or return the default one
## Note:
...
•An alarm monitors a metric (such as
Average CPU
, or a
custom metric
## )
...
## Dynamic Scaling
## •
Ta r g e t  Tr a c k i n g   S c a l i n g
•Simple to set-up
...
•Yo u   h a v e   a   p r o d u c t i o n   d a t a b a s e
that is taking on normal load
•Yo u   w a n t   t o   r u n   a   r e p o r t i n g
application to run some analytics
•Yo u   c r e a t e   a   R e a d   R e p l i c a   t o   r u n
...
•Postgres and MySQL are both suppor ted as Aurora DB (that means your
...
of < 1 minute
## •
Ty p i c a l   c r o s s-region replication takes less than 1 second
...
•Yo u   d o n ’ t   n e e d   t o   h a v e   M L   e x p e r i e n c e
...
•Tr a n s a c t i o n   l o g s   a r e   b a c k e d-up by RDS every 5 minutes
•=> ability to restore to any point in time (from oldest backup to 5 minutes ago)
•1 to 35 days of retention, set 0 to disable automated backups
•Manual DB Snapshots
•Manually triggered by the user
•Retention of backup for as long as you want
•Tr i c k :  i n   a   s t o p p e d   R D S   d a t a b a s e ,  yo u   w i l l   s t i l l   p a y   f o r   s t o r a g e .  I f   yo u   p l a n   o n
...
## •
Redis AUTH
•Yo u   c a n   s e t   a  “ p a s s w o r d / t o k e n ”  w h e n   y o u   c r e a t e   a
Redis cluster
...
## •
To p   L e v e l   D o m a i n   ( T L D ) :
## .com, .us, .in, .gov, .org, ...
## •
...
## •
## Public Hosted Zones –
contains records that specify how to route
...
## •
Wor ks for ROOT DOMAIN and NON ROOT DOMAIN (aka mydomain.com)
•Free of charge
•Native health check
...
example.comAMyALB-123456789.us-
east-
## 1.elb.amazonaws.com
AWS-Managed
...
•Ty p i c a l l y,  r o u t e   t r a f f i c   t o   a   s i n g l e
resource
...
resources
•Ability
to shift more traffic to resources based
on the defined
bias
•To   c h a n g e   t h e   s i z e   o f   t h e   g e o g r a p h i c   r e g i o n ,  s p e c i f y
bias
values:
...
## •Y
ou provide a list of CIDRs for your clients
...
LocationsCIDR blocks
location-1203.0.113.0/24
location-2200.5.4.0/24
CIDR Collection
## Route 53
Record NameValueIP-based
example.com1.2.3.4location-1
example.com5.6.7.8location-2
## Records
EC2 Instance
## (1.2.3.4)
EC2 Instance
...
•Up to 8 healthy records are returned for each Multi-Value quer y
## •
...
•Yo u   b u y   o r   r e g i s t e r   y o u r   d o m a i n   n a m e   w i t h   a   D o m a i n   R e g i s t r a r   t y p i c a l l y   b y
...
## 3
rd
Party Registrar with Amazon Route 53
## •
If you buy your domain on a 3
rd
party registrar, you can still use Route
53 as the DNS Service provider
1.Create a Hosted Zone in Route 53
2.Update NS Records on 3
rd
party website to use Route 53
## Name
## Servers
## •
...
## •
## Inbound Endpoint –
allows your DNS Resolvers to resolve domain names for
AWS resources (e.g., EC2 instances) and records in Private Hosted Zones
## Private Subnet
## VPC
us-east-1On-Premises Data Center
DNS Resolvers
## (onpremise.private)
## Server
...
•We want to fully scale ver tically and hor izontally, no downtime
...
•We need to scale , maintain hor izontal scalability and keep our web
...
•ELB sticky sessions
•Web clients for stor ing cookies and making our web app stateless
•ElastiCache
...
•We want that website to access and cor rectly display picture uploads
...
## •
Use a Golden AMI:
Install your applications, OS dependencies etc.. beforehand
...
Ty p i c a l   a r c h i t e c t u r e : We b  A p p   3-tier
Multi AZ
Availability zone 1
Auto Scaling group
Availability zone 2
...
•We still have full control over the configur ation
...
## •
## Application:
collection of Elastic Beanstalk components (environments,
...
## •
## Tiers:
Web Ser ver Environment Tier & Wor ker Environment Tier
...
Web Ser ver Tier vs. Wor ker Tier
Auto Scaling group
## Web Environment
...
•Not an IP
•Must star t with lowercase letter or number
•Must NOT star t with the prefix
xn--
...
•Ta g s   ( U n i c o d e   k e y   /   v a l u e   p a i r  – up to 10) – useful for security / lifecycle
•Ver sion ID (if ver sioning is enabled)
...
S3 BucketAnonymous www website visitor
## S3 Bucket Policy
...
Amazon S3 - Ver sioning
•Yo u   c a n   v e r s i o n   y o u r   f i l e s   i n  A m a z o n   S 3
•It is enabled at the
bucket level
...
## •
## SRR –
log aggregation, live replication between production and test
accounts
## S3 Bucket
## (eu-west-1)
## S3 Bucket
...
•Optionally, you can replicate existing objects using
## S3 Batch Replication
•Replicates existing objects and objects that failed replication
•For DELETE operations
## •
Can replicate delete markers
from source to target (optional setting)
...
## •
## Amazon S3 Glacier Instant Retrieval
•Millisecond retrieval, great for data accessed once a quar ter
...
## Min. Storage
## Duration Charge
NoneNone30 Days30 Days90 Days90 Days180 Days
## Min. Billable
## Object Size
NoneNone128 KB128 KB128 KB40 KB40 KB
...
StandardIntelligent-TieringStandard-IAOne Zone-IA
## Glacier Instant
## Retrieval
## Glacier Flexible
## Retrieval
...
storage class
•Objects stored in a
Directory Bucket (bucket in a single AZ)
•Handle 100,000s requests per second with
...
(reduces latency)
•Use cases: latency-sensitive apps, data-intensive apps, AI & ML
...
•Yo u   c a n   t r a n s i t i o n   o b j e c t s   b e t w e e n
storage classes
...
## •
Tr a n s i t i o n  A c t i o n s
...
•Can be used to delete incomplete Multi-Par t uploads
...
•S3 source images can be on
## Standard
, with a lifecycle configur ation to
transition them to
## Glacier
after 60 days
•S3 thumbnails can be on
One-Zone IA
, with a lifecycle configur ation to
...
## •E
nable S3 Versioning
in order to have object versions, so that “deleted
objects” are in fact hidden by a “delete marker” and can be recovered
•Tr a n s i t i o n   t h e  “ n o n c u r r e n t   v e r s i o n s ”  o f   t h e   o b j e c t   t o
Standard IA
•Tr a n s i t i o n   a f t e r w a r d s   t h e  “ n o n c u r r e n t   v e r s i o n s ”  t o
## Glacier Deep Archive
...
## S3 Bucket
## S3 Analytics
DateStorageClassObjectAge
## 8/22/2022STANDARD000-014
## 8/25/2022STANDARD030-044
## 9/6/2022STANDARD120-149
.csv report
...
•Yo u r   a p p l i c a t i o n   c a n   a c h i e v e   a t   l e a s t
...
sends completion notifications, generate repor ts ...
## •
...
•Ver sioningEnabledBucketCount, MFADeleteEnabledBucketCount, SSEKMSEnabledBucketCount,
...
•Tr a n s fe r A c c e l e r a t i o n E n a b l e d B u c k e t C o u n t (identify which buckets have S3 Transfer
...
GenerateDataKey
## KMS API
•When you download, it calls the
## Decrypt

## KMS API
•Count towards the KMS quota per second
(5500, 10000, 30000 req/s based on region)
•Yo u   c a n   r e q u e s t   a   q u o t a   i n c r e a s e   u s i n g   t h e
...
•Amazon S3 does
## NOT
store the encryption key you provide
## •
HTTPS must be used
...
## •
## Web Browser
based mechanism to allow requests to other origins while
...
•Yo u   c a n   a l l o w   f o r   a   s p e c i f i c   o r i g i n   o r   f o r   *   ( a l l   o r i g i n s )
## Web Browser
## S3 Bucket
## (my-bucket-html)
...
force users to generate a code on a
device (usually a mobile phone or hardware) before doing important
operations on S3
•MFA will be required to:
•Permanently delete an object ver sion
•Suspend Versioning on the bucket
•MFA won’t be required to:
•Enable Versioning
•List deleted versions
•To   u s e   M F A   D e l e t e ,
Ver sioning must be enabled
on the bucket
## •
...
•It will create a logging loop, and
your
...
•Generate pre-signed URLs using the
...
## •
## Retention Period
: protect the object for a fixed per iod, it can be extended
## •
## Legal Hold:
...
•Yo u   m u s t   c r e a t e   a  V P C
...
top of which we create
## S3 Access
## Point
and
## S3 Object Lambda Access
## Points.
•Use Cases:
...
•Yo u   c a n   r e s t r i c t   w h o   c a n   a c c e s s   y o u r   d i s t r i b u t i o n
## •
## Allowlist:
...
•The “country” is determined using a 3
rd
party Geo-IP database
...
the TTL) by performing a
CloudFront
## Invalidation
•Yo u   c a n   i n v a l i d a t e   a l l   f i l e s   ( * )   o r   a
special path (/images/*)
CloudFront
## Edge Location
index.html
...
•Yo u   h a v e   d e p l o y e d   a n
...
collect and process data at the
edge
, and
migrate data into and out of AWS
•Helps migrate up to Petabytes of data
## Snowball Edge
DeviceComputeMemoryStorage (SSD)
## Snowball Edge Storage Optimized
104 vCPUs416 GB210 TB
## Snowball Edge Compute Optimized
104 vCPUs416 GB28 TB
...
AWS Snowball: offline devices to perfor m data migr ations
...
•Process data while it’s being created on
an edge location
•A truck on the road, a ship on the sea, a mining station underground...
•These locations may have limited internet and no access to computing power
•We setup a
## Snowball Edge
device to do edge computing
•Snowball Edge Compute Optimized (dedicated for that use case) & Storage Optimized
•Run EC2 Instances or Lambda functions at the edge
•Use cases: preprocess data, machine lear ning, tr anscoding media
...
(group files across multiple FS)
...
## •
## Scratch File System
•Te m p o r a r y   s t o r a g e
...
•Par t of your infrastructure is on the cloud
•Par t of your infrastructure is on-premises
•This can be due to
...
BlockFileObject
Amazon EBSEC2 Instance
## Store
Amazon EFSAmazon FSxAmazon S3Amazon Glacier
...
•Ty p e s   o f   S t o r a g e   G a t e w a y :
## •
## S3 File Gateway
## •
## Volume Gateway
## •
Ta p e   G a t e w a y
## Storage Gateway
...
•Wor ks with leading backup software vendor s
## Corporate
## Data Center
AWS Cloud
## Region
...
– needs agent
•AWS to AWS (different storage ser vices) – no agent needed
•Can synchronize to:
...
AWS DataSync
Tr a n s f e r   b e t w e e n  AW S   s t o r a g e   s e r v i c e s
AWS DataSync
...
•The message is
persisted
in SQS until a consumer deletes it
...
## Request
Message returned (again)
•If a message is not processed within the visibility timeout, it will be processed
twice
...
## •
## Ordering
by Message Group ID (all messages in the same group are ordered)
– mandatory parameter
...
•To p i c   P u b l i s h   ( u s i n g   t h e   S D K )
•Create a topic
...
•Wor ks with Google GCM, Apple APNS, Amazon ADM...
...
•Make sure your SQS queue
access policy
allows for SNS to write
...
•Collect and store streaming data in
real-time
## Click Streams
IoT devices
## Metrics & Logs
...
•Data up to 10MiB (typical use case is lot of  “small”
real-time data
## )
...
•Yo u   p a y   p e r   s h a r d   p r o v i s i o n e d   p e r   h o u r
## •
On-demand mode:
...
## •
Near Real-Time
with buffering capability based on size / time
...
•Tr a d i t i o n a l   a p p l i c a t i o n s   r u n n i n g   f r o m   o n-premises may use open protocols
such as: MQTT, AMQP, STOMP, Openwire, WSS
## •
When migrating to the cloud
, instead of re-engineering the application to use
...
•Apps are packaged in
containers
that can be run on any OS
...
•Wor ks with any language , any OS, any technology
...
•AWS takes care of star ting / stopping
containers
...
•Launch Docker containers on AWS
## •
Yo u   d o   n o t   p r o v i s i o n   t h e   i n f r a s t r u c t u r e
(no EC2 instances to manage)
## •
It’s all Serverless!
•Yo u   j u s t   c r e a t e   t a s k   d e f i n i t i o n s
•AWS just r uns ECS Tasks for you based
on the CPU / RAM you need
•To   s c a l e ,  j u s t   i n c r e a s e   t h e   n u m b e r   o f
...
you run
•Ta s k   R o l e   i s   d e f i n e d   i n   t h e
task definition
EC2 Instance
ECS Agent
## Task A
...
## Fargate
launch types
•Ta s k s   r u n n i n g   i n   a n y  A Z   w i l l   s h a r e   t h e   same data
...
•Amazon ECS Auto Scaling uses
AWS Application Auto Scaling
•ECS Service Average CPU Utilization
•ECS Service Average Memory Utilization - Scale on RAM
•ALB Request Count Per Target – metric coming from the ALB
## •
Ta r g e t  Tr a c k i n g  –
...
Amazon EKS Overview
•Amazon EKS = Amazon Elastic
## Kubernetes
## Service
•It is a way to launch
managed

Kubernetes clusters on AWS
•Kubernetes is an
open-source system
for automatic deployment, scaling and
management of containerized (usually Docker) application
•It’s an alternative to ECS, similar goal but different API
•EKS supports
## EC2
if you want to deploy worker nodes or
## Fargate
to deploy
serverless containers
## •
Use case:
if your company is already using Kubernetes on-premises or in
another cloud, and wants to migrate to AWS using Kubernetes
## •
Kubernetes is cloud-agnostic
(can be used in any cloud – Azure, GCP...)
•For multiple regions, deploy one EKS cluster per region
•Collect logs and metrics using
...
AWS Cloud
## VPC
Availability Zone 1Availability Zone 2Availability Zone 3
Public subnet 1Public subnet 2Public subnet 3
## NGW
## NGW
## NGW
## ELB
...
•Yo u   c a n   u s e   p r e b u i l t  A M I  - Amazon EKS Optimized AMI
•Supports On-Demand or Spot Instances
## •
AWS Fargate
...
•CLI tool for migrating and modernizing
## Java
and
## .NET
web apps into
...
## •
## Lift-and-shift
your apps running in on-premises bare metal, virtual
...
Main ones
CloudWatch LogsSNSCognito
## SQS
S3KinesisAPI GatewayDynamoDBCloudFront
CloudWatch Events
EventBridge
...
•Yo u   c a n   f i n d   o v e r a l l   p r i c i n g   i n f o r m a t i o n   h e r e :
...
•Pay per
duration
: (in increment of 1 ms)
•400,000 GB-seconds of compute time per month for FREE
•== 400,000 seconds if function is 1GB RAM
•== 3,200,000 seconds if function is 128 MB RAM
•After that $1.00 for 600,000 GB-seconds
•It is usually ver y cheap to run AWS Lambda so it’s ver y popular
...
•Ta k e s   a   s n a p s h o t   o f   m e m o r y   a n d   d i s k   s t a t e   o f   t h e
...
## &
Lambda@Edge
•Yo u   d o n ’ t   h a v e   t o   m a n a g e   a n y   s e r v e r s ,  d e p l o y e d   g l o b a l l y
...
## Use Cases
•Website Secur ity and Pr ivacy
...
## •
## Viewer Request:
after CloudFront receives a request from a
viewer
## •
## Viewer Response:
before CloudFront forwards the response
to the viewer
...
## •
## Viewer Response –
before CloudFront forwards the response to
the viewer
...
PricingFree tier available, 1/6
th
...
•Tr a n s f o r m   r e q u e s t   a t t r i b u t e s   ( h e a d e r s ,
...
Private subnet
Lambda in VPC
•Yo u   m u s t   d e f i n e   t h e  V P C   I D,  t h e
...
•Yo u   d o n ’ t   h a v e   a n y   i n f o r m a t i o n   a b o u t   t h e   d a t a   i t s e l f
...
DynamoDB – Ta b l e   e x a m p l e
...
•Yo u   s p e c i f y   t h e   n u m b e r   o f   r e a d s / w r i t e s   p e r   s e c o n d
•Yo u   n e e d   t o   p l a n   c a p a c i t y   b e f o r e h a n d
...
•Make a DynamoDB table accessible with
low latency
in multiple-regions
...
User_IDSession_ID
ExpTime (TTL)
## 7791a3d6-...746865726521631188571
## 873e0634-...6e6f74686961631274971
a80f73a1-...746f20736561631102171
SessionData (Table)
## Expiration Process
...
AWS API Gateway
•AWS Lambda + API Gateway: No infrastr ucture to manage
...
•Tr a n s f o r m   a n d   v a l i d a t e   r e q u e s t s   a n d   r e s p o n s e s
...
•If using Edge-Optimized endpoint, then the certificate must be in
us-east-1
...
•Users source can be Cognito User Pools, 3
rd
party logins, etc...
## •
...
•We’ve seen static content being distr ibuted using CloudFront with S3
•The REST API was serverless, didn’t need Cognito because public
•We lever aged a Global DynamoDB table to ser ve the data globally
•(we could have used Aurora Global Database)
•We enabled DynamoDB streams to tr igger a Lambda function
...
Amazon API GatewayAWS LambdaElastiCache
...
•Yo u   c a n   e a s i l y   c l o n e  A P I ,  r e p r o d u c e   e n v i r o n m e n t s
...
•We’ll also save in availability, networ k bandwidth cost, etc
...
## •
## Data Warehouse
(= SQL Analytics / BI): Redshift (OLAP), Athena, EMR
## •
## Search:
...
## •
## Use Case:
Key/Value store, Frequent reads, less writes, cache results for DB
...
•AWS proprietar y technology, managed ser ver less NoSQL database, millisecond latency
...
## •
## Use Case:
Serverless applications development (small documents 100s KB), distributed serverless
cache
...
## •
## Features:
Ver sioning, Encr yption, Replication, MFA-Delete, Access Logs...
## •
## Security:
...
•Great for knowledge graphs (Wikipedia), fr aud  d e te c tio n,
...
## •
Real-time ordered
sequence of every change to
your graph data
•Changes are available immediately after writing
## •
No duplicates, strict order
•Streams data is accessible in an
## HTTP REST API
•Use cases:
...
## •
## Serverless
query service to analyze data stored in Amazon S3
...
## •
Use cases:
Business intelligence / analytics / reporting, analyze &
...
•Use
columnar data
for cost-savings (less scan)
•Apache Parquet or ORC is recommended
•Huge performance improvement
•Use Glue to convert your data to Parquet or ORC
## •
Compress data
for smaller retrievals (bzip2, gzip, lz4, snappy, zlip, zstd...)
## •
Par tition
datasets in S3 for easy querying on virtual columns
...
## Redshift Overview
•Redshift is based on PostgreSQL, but
...
## •
## Columnar
storage of data (instead of row based) & parallel query engine
•Tw o   m o d e s :  P r o v i s i o n e d   c l u s t e r   o r   S e r v e r l e s s   c l u s t e r
...
changed is saved)
•Yo u   c a n   r e s t o r e   a   s n a p s h o t   i n t o   a
new cluster
•Automated: every 8 hours, every 5 GB, or on a
schedule. Set retention between 1 to 35 days
•Manual: snapshot is retained until you delete it
## •
Yo u   c a n   c o n f i g u r e  A m a z o n   R e d s h i f t   t o
...
available to star t the quer y
...
•Tw o   m o d e s :  m a n a g e d   c l u s t e r   o r   s e r v e r l e s s   c l u s t e r
...
## •
Ta s k   N o d e   ( o p t i o n a l ) :
...
## •
Yo u   c a n   s h a r e   t h e   a n a l y s i s   o r   t h e   d a s h b o a r d   w i t h   U s e r s   o r   G r o u p s
•To   s h a r e   a   d a s h b o a r d ,  y o u   m u s t   f i r s t   p u b l i s h   i t
...
•Fully managed service that makes it easy to setup a
data lake
in days
...
•We want the ingestion pipeline to be fully ser ver less
•We want to collect data in real time
•We want to tr ansfor m the data
•We want to quer y the tr ansfor med data using SQL
...
## Amazon Simple Queue
## Service
AWS LambdaAmazon AthenaAmazon Simple Storage
Service (S3)
## Reporting
## Bucket
IoT Devices
...
and
facial search
to do user verification, people counting
...
•Pathing (ex: for spor ts game analysis)
...
•Customize the pronunciation of words with
Pronunciation lexicons
•Stylized words: St3ph4ne => “Stephane”
•Acronyms: AWS => “Amazon Web Services”
•Upload the lexicons and use them in the
SynthesizeSpeech
operation
•Generate speech from plain text or from documents marked up with
## Speech
...
•Amazon Translate allows you to
localize content
- such as websites and
applications - for
international users
, and to easily tr anslate lar ge
...
## •
## Amazon Connect:
•Receive calls, create contact flows, cloud-based
...
•Ty p i c a l l y,  d i f f i c u l t   t o   d o   a l l   t h e   p r o c e s s e s   i n   o n e   p l a c e   +   p r o v i s i o n   s e r v e r s
...
## •
SageMaker
: machine lear ning for ever y developer and data scientist
## •
## Kendra:
...
•CloudWatch provides metrics for ever y services in AWS
## •
## Metric
...
## •
## Dimension
is an attribute of a metric (instance id, environment, etc...).
...
## •3
rd
party service provider: Datadog,
...
send log events to resources in a different AWS
account (KDS, KDF)
## Account – Sender
## (111111111111)
CloudWatch
...
•Yo u   n e e d   t o   r u n   a   C l o u d W a t c h
...
## •
Disk metrics
(free, used, total), Disk IO (writes, reads, bytes, iops)
## •
## RAM
...
•Tr i g g e r  A u t o   S c a l i n g  A c t i o n
•Send notification to SNS (from which you can do pretty much anything)
Amazon EC2
EC2 Auto ScalingAmazon SNS
...
•To   t e s t   a l a r m s   a n d   n o t i f i c a t i o n s ,  s e t   t h e   a l a r m   s t a t e   t o  A l a r m   u s i n g   C L I
...
•Tr i g g e r   L a m b d a   f u n c t i o n s ,  s e n d   S Q S / S N S   m e s s a g e s ...
...
•Yo u   c a n
archive events
(all/filter) sent to an event bus (indefinitely or set period)
•Ability to
...
•Wor ks for any AWS-generated logs (VPC, DNS, etc..)
•For example, you can find bad hosts,
identify the
heaviest network users,
or find the URLs that generate
the most errors.
•Yo u   c a n   b u i l d   y o u r   r u l e s   f r o m   s c r a t c h ,  o r   y o u   c a n   a l s o
use sample rules that AWS has created
– leverages
...
•Can separate
## Read Events
(that don’t modify resources) from
## Write Events
(that may modify resources)
## •
## Data Events:
## •
...
•Yo u   c a n   r e c e i v e   a l e r t s   ( S N S   n o t i f i c a t i o n s )   f o r   a n y   c h a n g e s
...
•Yo u   c a n   s e t
## Remediation Retries
if the resource is still non-compliant after auto-
remediation
IAM Access Key
## (NON_COMPLIANT)
expired
...
•CloudWatch
•Performance monitoring (metrics, CPU, networ k, etc...) & dashboards
•Events & Aler ting
...
•Config:
•Tr a c k   s e c u r i t y   g r o u p   r u l e s   f o r   t h e   L o a d   B a l a n c e r
•Tr a c k   c o n fi g u r a t i o n   c h a n g e s   f o r   t h e   L o a d   B a l a n c e r
•Ensure an SSL certificate is always assigned to the Load Balancer (compliance)
•CloudTrail:
•Tr a c k   w h o   m a d e   a n y   c h a n g e s   t o   t h e   L o a d   B a l a n c e r   w i t h  A P I   c a l l s
...
AWS Organizations – Ta g   Po l i c i e s
...
•Yo u   d e f i n e   t a g   k e y s   a n d   t h e i r   a l l o w e d   v a l u e s
...
## •
aws:PrincipalOrgID
can be used in any resource policies to restrict
...
## •3
rd
party: Active Directory (AD), OneLogin, Okta...
...
AWS Control Tower
•Easy way to
set up and govern a secure and compliant multi-account
AWS environment
...
(e.g., Restrict Regions across all your accounts)
## •
## Detective

Guardrail – using AWS Config
...
•AWS manages encr yption keys for us
...
•AWS ser vices that are integrated with KMS use Symmetric CMKs
•Yo u   n e v e r   g e t   a c c e s s   t o   t h e   K M S   K e y   u n e n c r y p t e d   ( m u s t   c a l l   K M S  A P I   t o   u s e )
## •
...
AWS KMS (Key Management Ser vice)
•Ty p e s   o f   K M S   K e y s :
•AWS Owned Keys (free): SSE-S3, SSE-SQS, SSE-DDB (default key)
•AWS Managed Key:
free
(aws/service-name, example: aws/rds or aws/ebs)
...
•Each Multi-Region key is managed
independently
## •
Use cases:
...
•We can encr ypt specific attr ibutes client-side
in our DynamoDB table using the
## Amazon
...
•Yo u   m i g h t   g e t   K M S   t h r o t t l i n g   e r r o r s ,  i n   w h i c h   c a s e   y o u   c a n   a s k   f o r   a   S e r v i c e   Q u o t a s   i n c r e a s e
## •
Yo u   c a n   u s e   m u l t i-region AWS KMS Keys, but they are currently treated as
...
from Source Account
2.Must modify the image attribute to add a
## Launch
## Permission
which corresponds to the specified target
AWS account
...
•Ver sion tr acking of configur ations / secrets
...
Storage PricingFree$0.05 per advanced parameter per
month
...
•CloudHSM => AWS provisions encryption
hardware
•Dedicated Hardware (HSM = Hardware Security Module)
•Yo u   m a n a g e   y o u r   o w n   e n c r y p t i o n   k e y s   e n t i r e l y   ( n o t  A W S )
•HSM device is tamper resistant, FIPS 140-2 Level 3 compliance
•Supports both symmetric and
asymmetric
encryption (SSL/TLS keys)
...
StandardFIPS 140-2 Level 3FIPS 140-2 Level 3
Master Keys•AWS Owned CMK
•AWS Managed CMK
...
CloudHSM vs. KMS
FeatureAWS KMSAWS CloudHSM
High AvailabilityAWS Managed ServiceAdd multiple HSMs over different AZs
...
•We can use Global Acceler ator for fixed IP and WAF on the ALB
## Global Accelerator
Fixed IPv4: 1.2.3.4
us-east-1
## Application Load
...
•WAF r ules (Application Load Balancer, API Gateways, CloudFront)
•AWS Shield Advanced (ALB, CLB, NLB, Elastic IP, CloudFront)
•Security Groups for EC2, Application Load BAlancer and ENI resources in VPC
•AWS Networ k Firewall (VPC Level)
...
AWS Firewall ManagerAWS WAFAWS Shield
...
•Uses Machine Learning algorithms, anomaly detection, 3
rd
party data
...
that uses
machine learning and pattern matching to discover and
protect your sensitive data in AWS.
•Macie helps identify and alert you to
...
•Used in
## Security Groups
rules and AWS networking in general
•They help to define an IP address range:
•We’ve seen WW.XX.YY.ZZ
## /32
=> one IP
•We’ve seen 0.0.0.0
## /0
=> all IPs
•But we can define:192.168.0.0
## /26
=>192.168.0.0 – 192.168.0.63 (64 IP addresses)
...
## •
Private IP
can only allow cer tain values:
...
## •
Yo u r  V P C   C I D R   s h o u l d   N OT   o v e r l a p   w i t h   y o u r   o t h e r   n e t w o r k s   ( e . g . ,  c o r p o r a t e )
...
•Yo u   n e e d   t o   c r e a t e   a n  A S G   i n   m u l t i-AZ + resilient user-data script
•Internet traffic bandwidth depends on EC2 instance type
•Yo u   m u s t   m a n a g e   S e c u r i t y   G r o u p s   &   r u l e s :
•Inbound:
...
AvailabilityHighly available within AZ (create in another AZ)Use a script to manage failover between instances
BandwidthUp to 100 GbpsDepends on EC2 instance type
MaintenanceManaged by AWSManaged by you (e.g., software, OS patches, ...)
CostPer hour & amount of data transferred Per hour, EC2 instance type and size, + network $
Public IPv4
Private IPv4
## Security Groups
Use as Bastion Host?
...
•NACL are like a firewall which control traffic from and to
subnets
## •
One NACL per subnet,
new subnets are assigned the
Default NACL
•Yo u   d e f i n e
NACL Rules:
...
•Do
## NOT
modify the Default NACL, instead create custom NACLs
...
## •
Yo u   m u s t   u p d a t e   r o u t e   t a b l e s   i neach VPC’s
...
•Yo u   c a n   c r e a t e  V P C   P e e r i n g   c o n n e c t i o n   b e t w e e n  V P C s   i n
different AWS
accounts/regions
•Yo u   c a n   r e f e r e n c e   a   s e c u r i t y   g r o u p   i n   a   p e e r e d  V P C   ( w o r k s   c r o s s
...
## Private Subnet
Ty p e s   o f   E n d p o i n t s
## •
...
RDS, ElastiCache, Redshift, Wor kSpaces, NATGW, Tr ansit Gateway...
...
## •
srcport & dstport
– help identity problematic ports
## •
## Action
– success or failure of the request due to Security Group / NACL
...
VPC Flow Logs – Tr o u b l e s h o o t   S G   &   N AC L   i s s u e s
## Subnet
## Security Group
EC2 Instance
## NACL
...
public Internet
•To   s e t   i t   u p ,  c o n n e c t   m u l t i p l e  V P N
...
Connect locations
•Yo u   n e e d   t o   s e t u p   a  V i r t u a l   P r i v a t e   G a t e w a y   o n   y o u r  V P C
...
Tr a n s i t   G a t e w ay
## •
For having transitive peering between thousands of VPC and
on-premises, hub-and-spoke (star) connection
•Regional resource, can work cross-region
•Share cross-account using Resource Access Manager (RAM)
•Yo u   c a n   p e e r  Tr a n s i t   G a t e w a y s   a c r o s s   r e g i o n s
•Route Tables: limit which VPC can talk with other VPC
•Wor ks with Direct Connect Gateway, VPN connections
•Supports
IP Multicast
(not supported by any other AWS
service)
AWS Direct
## Connect Gateway
Amazon VPC
...
Tr a n s i t   G a t e w ay :  S i t e-to-Site VPN ECMP
## •
...
Tr a n s i t   G a t e w ay :  t h r o u g h p u t   w i t h   E C M P
...
Tr a n s i t   G a t e w ay  – Share Direct Connect
...
VPC – Tr a f fi c   M i r r o r i n g
...
## •
To   ( Ta r g e t s )  –
an ENI or a Network Load Balancer
...
•IPv6 is designed to provide 3.4	×	10
## ,-
unique IP addresses
## •
Every IPv6 address in AWS is public
and Internet-routable (no private range)
•Format è x.x.x.x.x.x.x.x (
x
is hexadecimal, range can be from 0000 to ffff)
•Examples:
...
IPv4 Tr o u bl e s h o o t i n g
## •
...
to your instances
## •
Yo u   m u s t   u p d a t e   t h e   R o u t e  Ta b l e s
## VPC
## Internet
## Gateway
## Public Subnet
...
## •
## Route Tables –
must be edited to add routes from subnets to the IGW, VPC Peering
Connections, VPC Endpoints, ...
## •
## Bastion Host –
public EC2 instance to SSH into, that has SSH connectivity to EC2
instances in private subnets
## •
NAT Instances –
gives Internet access to EC2 instances in private subnets. Old, must
be setup in a public subnet, disable Source / Destination check flag
## •
NAT Gateway –
managed by AWS, provides scalable Internet access to private EC2
...
## •
## NACL –
stateless, subnet rules for inbound and outbound, don’t forget Ephemeral
Por ts
## •
## Security Groups –
...
## •
VPC Endpoints –
provide private access to AWS Services (S3, DynamoDB,
CloudFormation, SSM) within a VPC
## •
VPC Flow Logs –
can be setup at the VPC / Subnet / ENI Level, for ACCEPT and
REJECT traffic, helps identifying attacks, analyze using Athena or CloudWatch Logs
## Insights
## •
Site-to-Site VPN –
setup a Customer Gateway on DC, a Virtual Private Gateway on
...
## •
## Direct Connect –
setup a Virtual Private Gateway on VPC, and establish a
direct private connection to an AWS Direct Connect Location
## •
## Direct Connect Gateway –
setup a Direct Connect to many VPCs in different
AWS regions
## •
...
•To   p r o t e c t   n e t w o r k   o n  A W S ,  w e ’ v e   s e e n
...
## •
Tr a f fi c   fi l t e r i n g : A l l o w,  d r o p,  o r   a l e r t   f o r   t h e   t r a f fi c   t h a t   m a t c h e s   t h e   r u l e s
## •
Active flow inspection
to protect against network threats with intrusion-prevention
...
•Ver y low RTO (minutes or seconds) – ver y expensive
...
•Quickly and easily
recover
your physical, vir tual, and cloud-based servers into AWS
...
AWS Schema Conver sion Tool (SCT)
•Convert your Database’s Schema from one engine to another
•Example OLTP: (SQL Server or Oracle) to MySQL, PostgreSQL, Aurora
•Example OLAP: (Teradata or Oracle) to Amazon Redshift
•Prefer compute-intensive instances to optimize data conversions
## •
Yo u   d o   n o t   n e e d   t o   u s e   S C T   i f   y o u   a r e   m i g r a t i n g   t h e   s a m e   D B   e n g i n e
...
•Tr a c k   w i t h  AW S   M i g r a t i o n   H u b
•AWS Database Migration Ser vice (DMS)
•replicate On-premise => AWS , AWS => AWS, AWS => On-premise
•Wor ks with var ious database technologies (Or acle , MySQL, DynamoDB , etc ..)
...
•Yo u   c r e a t e   b a c k u p   p o l i c i e s   k n o w n   a s
## Backup Plans
•Backup frequency (every 12 hours, daily, weekly, monthly, cron expression)
•Backup window
•Tr a n s i t i o n   t o   C o l d   S t o r a g e   ( N e v e r,  D a y s , We e k s ,  M o n t h s , Ye a r s )
...
backups against:
•Inadver tent or malicious delete operations
...
Tr a n s f e r r i n g   l a r g e   a m o u n t   o f   d a t a   i n t o  AW S
...
Site-to-Site VPN or DX with DMS or
DataSync
...
•Yo u   c a n   c r e a t e   a   v e r y   h i g h   n u m b e r   o f   r e s o u r c e s   i n   n o   t i m e
•Yo u   c a n   s p e e d   u p   t i m e   t o   r e s u l t s   b y   a d d i n g   m o r e   r e s o u r c e s
•Yo u   c a n   p a y   o n l y   f o r   t h e   s y s t e m s   y o u   h a v e   u s e d
•Perform genomics, computational chemistr y, financial risk modeling,
...
## •
## EBS:
scale up to 256,000 IOPS with io2 Block Express
## •
## Instance Store:
scale to millions of IOPS, linked to EC2 instance, low latency
•Network storage:
## •
## Amazon S3:
large blob, not a file system
## •
Amazon EFS:
...
## •
AWS Batch
supports multi-node parallel jobs, which enables you to run single
jobs that span multiple
## EC2
instances.
...
•Yo u   c a n   e s t i m a t e   t h e   c o s t s   o f   y o u r   r e s o u r c e s   u s i n g   t h e   C l o u d F o r m a t i o n   t e m p l a t e
...
•Everything we’ll see in this course is suppor ted
•Yo u   c a n   u s e  “ c u s t o m   r e s o u r c e s ”  f o r   r e s o u r c e s   t h a t   a r e   n o t   s u p p o r t e d
...
stack
•Use cases:
•Yo u   w a n t   t o   a c h i e v e   t h e   l e a s t   p r i v i l e g e   p r i n c i p l e
...
## •
Ver sus Amazon SNS or Amazon SES
...
## •
## Hybrid Cloud
: bus ine s s e s  that ke e p  an o n-
...
•Yo u   a r e   r e s p o n s i b l e   f o r   t h e   O u t p o s t s   R a c k
physical security
## Corporate
data center
## AWS
...
•Batch will dynamically launch
EC2 instances
or
## Spot Instances
•AWS Batch provisions the right amount of compute / memor y
•Yo u   s u b m i t   o r   s c h e d u l e   b a t c h   j o b s   a n d  A W S   B a t c h   d o e s   t h e   r e s t !
•Batch jobs are defined as
Docker images
and
run on ECS
...
•Sources:
## Salesforce
, SAP, Zendesk, Slack, and Ser viceNow
•Destinations:
...
applications
•Authentication, Storage, API (REST, GraphQL), CI/CD, PubSub, A naly tic s , A I/ML P re d ic tio ns ,
## Monitoring, ...
•Connect your source code from GitHub, AWS CodeCommit, Bitbuc ke t, GitLab, o r up lo ad  d ire c tly
...
## White Papers & Architectures
Well Architected Fr amewor k, Disaster Recover y, etc...
...
## Section Overview
•Well Architected Fr amewor k Whitepaper
•Well Architected Tool
•AWS Tr usted Advisor
...
Well Architected Fr amewor k
## General Guiding Principles
## •https://aws.amazon.com/architecture/well-architected
•Stop guessing your capacity needs
•Te s t   s y s t e m s   a t   p r o d u c t i o n   s c a l e
...
against the 6 pillars Well-Architected
Framework and
adopt architectural best practices
•How does it work?
...
•We’ve explored the most impor tant architectur al patter ns:
## •
## Classic:
EC2, ELB, RDS, ElastiCache, etc...
## •
## Serverless:
S3, Lambda, DynamoDB, CloudFront, API Gateway, etc...
...
•Yo u   c a n   r e a d   a b o u t   s o m e  A W S  W h i t e   P a p e r s   h e r e :
•Architecting for the Cloud: AWS Best Practices
•AWS Well-Architected Framework
•AWS Disaster Recover y (https://aws.amazon.com/disaster-recovery/)
...
•Watch re-invent videos on Yo u t u b e (AWS Conference)
...
•Yo u ’ l l   h a v e   t o   r e g i s t e r   o n l i n e   a t  https://www.aws.training/
...
•Yo u   w i l l   k n o w   t h e   o v e r a l l   s c o r e   a   f e w   d a y s   l a t e r   ( e m a i l   n o t i f i c a t i o n )
•Yo u   w i l l   n o t   k n o w   w h i c h   a n s w e r s   w e r e   r i g h t   /   w r o n g
...
Yo u r  A W S   C e r t i f i c a t i o n   j o u r n e y
## Foundational
